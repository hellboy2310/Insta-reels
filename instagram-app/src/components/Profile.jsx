...
function Profile(){
    ...
    return(
        <>
        {user == null?<div>you need to login</div>:<div>user is {user.uid}</div>}
       <div>Hello world</div>
        </>
